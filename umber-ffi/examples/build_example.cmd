...
cargo build -p umber-ffi %CARGO_FLAG% || exit /b 1
...
copy /y "target\%CFG%\umber_ffi.dll" "%BINDIR%\" >nul || exit /b 1
copy /y "target\%CFG%\umber_ffi.dll.lib" "%BINDIR%\" >nul || exit /b 1

call "%VSPATH%\VC\Auxiliary\Build\vcvars64.bat" >nul || exit /b 1
rem /utf-8: umber.h 与示例的注释是中文，缺这个开关在 GBK 代码页下会报 C4819
cl /nologo /W4 /utf-8 /I "umber-ffi\include" "umber-ffi\examples\host_example.c" /Fe:"%BINDIR%\host_example.exe" /Fo:"%BINDIR%\host_example.obj" /link "%BINDIR%\umber_ffi.dll.lib" || exit /b 1
