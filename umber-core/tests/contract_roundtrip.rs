...
use umber_core::content::{ReasoningBlock, TextBlock, ToolCallBlock, ToolResultBlock};
use umber_core::error::{ErrorDetail, ModelError};
use umber_core::event::{ModelEvent, SequenceValidator, SequencedEvent};
use umber_core::ids::{BlockId, CallId, DeploymentId, InvocationId};
use umber_core::invocation::{Invocation, InvocationState, PartialOutput};
use umber_core::message::Message;
use umber_core::request::{GenerateRequest, Tool, ToolChoice};
...
fn full_invocation_scenario_roundtrips_through_json() {
    ...
    let mut request = GenerateRequest::new(
        ...
        vec![
            ...
            Message::user("查一下天气"),
            Message::assistant(vec![umber_core::ContentBlock::ToolCall(ToolCallBlock {
            ...
            Message::new(
                ...
                vec![umber_core::ContentBlock::ToolResult(ToolResultBlock {
                    call_id: CallId::from("call-1"),
                    is_error: false,
                    content: vec![umber_core::ContentBlock::text("晴 28°C")],
                })],
            ),
        ],
    );
        ...
        SequencedEvent {
            ...
            event: ModelEvent::Completed {
                response: Box::new(GenerateResponse {
                    invocation_id: InvocationId::from("inv-1"),
                    content: vec![
                        umber_core::ContentBlock::Reasoning(ReasoningBlock {
                            text: "用户想查天气".into(),
                        ...
                        umber_core::ContentBlock::Text(TextBlock::new("好的")),
                    ],
    ...
    let partial = PartialOutput {
        content: vec![umber_core::ContentBlock::Text(TextBlock::new(
            "已经生成的开头",
        ))],
