...
use umber_core::content::{CacheControl, ContentBlock};
use umber_core::error::ModelError;
use umber_core::event::ModelEvent;
use umber_core::message::{Message, Role};
use umber_core::request::{GenerateRequest, ReasoningConfig, ReasoningEffort, Tool, ToolChoice};
...
use umber_protocol::anthropic::{build_request_body, AnthropicAdapter};
...
fn deployment() -> Deployment {
    Deployment {
        ...
        protocol: umber_model::deployment::ProtocolKind::AnthropicMessages,
...
fn replay_includes_thinking_block_with_signature() {
    ...
    assert_eq!(
        ...
        umber_protocol::anthropic::effort_to_budget(ReasoningEffort::High)
    );
}
