...
//!
//! 档位枚举的唯一定义在 `runtime-core::request::ReasoningEffort`
...
// 档位枚举的唯一定义在 runtime-core（它是 Canonical API 的一部分）；
// 这里公开再导出，让 runtime-model 的消费者只需依赖一个 crate。
pub use runtime_core::request::ReasoningEffort;
