...
fn modalities(value: Option<&Value>) -> Vec<umber_model::model::Modality> {
    value
...
impl SourceAdapter for OpenRouterAdapter {
    ...
    fn parse(&self, upstream: &Value) -> Result<Vec<RawModelRecord>, SourceError> {
        ...
        for item in items {
            ...
            let vision = record
                .input_modalities
                .contains(&umber_model::model::Modality::Image);
            let audio = record
                .input_modalities
                .contains(&umber_model::model::Modality::Audio);
...
mod tests {
    ...
    fn modalities_drive_vision_and_audio() {
        ...
        assert!(records[0]
            .output_modalities
            .contains(&umber_model::model::Modality::Text));
    }
