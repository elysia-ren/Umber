...
pub const BUILTIN_STRINGS_ZH: &[(&str, &str)] = &[
    ...
    ("plan.mimo.token_plan_cn", "Token Plan（中国集群）"),
    ("plan.mimo.token_plan_sgp", "Token Plan（新加坡集群）"),
    ("plan.mimo.token_plan_ams", "Token Plan（欧洲集群）"),
    ("plan.dashscope.token_plan", "百炼 Token Plan"),
    ("plan.qianfan.token_plan_personal", "千帆 Token Plan 个人版"),
    ("plan.qianfan.token_plan_team", "千帆 Token Plan 企业版"),
    ("plan.iflytek.coding", "星火 Coding Plan"),
    ("plan.huawei.token_plan", "盘古 Token Plan"),
    ("plan.jdcloud.token_plan", "言犀 TokenPlan"),
    ("plan.telecom.coding", "星辰编程 Token Plan"),
    ...
    ("provider.iflytek", "讯飞星火"),
    ("provider.internlm", "书生 InternLM"),
    ("provider.huawei", "华为云盘古"),
    ("provider.jdcloud", "京东云言犀"),
    ("provider.antling", "蚂蚁百灵 Ling"),
    ("provider.telecom", "天翼云星辰"),
...
pub const BUILTIN_STRINGS_EN: &[(&str, &str)] = &[
    ...
    ("plan.mimo.token_plan_cn", "Token Plan (China cluster)"),
    ...
    ("plan.qianfan.token_plan_personal", "Qianfan Token Plan (personal)"),
    ("plan.qianfan.token_plan_team", "Qianfan Token Plan (team)"),
    ("plan.iflytek.coding", "Spark Coding Plan"),
    ("plan.huawei.token_plan", "Pangu Token Plan"),
    ("plan.jdcloud.token_plan", "Yanxi TokenPlan"),
    ("plan.telecom.coding", "Xingchen Coding Token Plan"),
    ("plan.tokenhub.coding", "TokenHub Coding Plan"),
    ("plan.tokenhub.token_plan", "TokenHub Token Plan"),
    ...
    ("provider.iflytek", "iFlytek Spark"),
    ("provider.internlm", "InternLM"),
    ("provider.huawei", "Huawei Cloud Pangu"),
    ("provider.jdcloud", "JD Cloud Yanxi"),
    ("provider.antling", "Ant Ling"),
    ("provider.telecom", "China Telecom Xingchen"),
    ("provider.minimax", "MiniMax"),
