            ...
            Role::System => {
                for b in &message.content {
                    if let ContentBlock::Text(t) = b {
                        ...
                        if let Some(runtime_core::content::CacheControl::Ephemeral) =
                            t.cache_control
                        {
...
fn image_block(i: &runtime_core::content::ImageBlock) -> serde_json::Value {
    match &i.source {
        runtime_core::content::MediaSource::Url { url } => {
