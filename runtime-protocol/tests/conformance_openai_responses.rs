...
use runtime_core::request::{GenerateRequest, ReasoningConfig, ReasoningEffort};
...
use runtime_protocol::openai_responses::{build_request_body, OpenAiResponsesAdapter};
...
fn deployment() -> Deployment {
    Deployment {
        ...
        protocol: runtime_model::deployment::ProtocolKind::OpenAiResponses,
        model_id: "gpt-5".into(),
    }
}
