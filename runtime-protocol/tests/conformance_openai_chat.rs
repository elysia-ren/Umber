...
use runtime_core::request::{GenerateRequest, ReasoningEffort, ResponseFormat, Tool, ToolChoice};
...
use runtime_protocol::openai_chat::{build_request_body, OpenAiChatAdapter};
...
fn deployment() -> Deployment {
    Deployment {
        ...
        protocol: runtime_model::deployment::ProtocolKind::OpenAiChat,
